...
const USER_ROLE = process.env.USER_ROLE || 'elevator-lift-user';
const ADMIN_ROLE = process.env.ADMIN_ROLE || 'elevator-lift-admin';
const CLIENT_ID = process.env.AUTH_CLIENT_ID || "elevator-lift";
